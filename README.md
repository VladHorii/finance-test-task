...
1. Подключение к серверу с использованием socket.io
2. Отображение изменение цен в реальном времени
3. Возможность преостановить/возобновить получение обновлённых данных конкретного тикера (PausedList)
4. Возможность удалить/добавить тикер
5. Изменение интервала обновления интерфейса 
